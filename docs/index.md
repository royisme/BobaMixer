...
hero:
  name: "BobaMixer"
  text: "AI工作流的智能路由器"
  tagline: 像调度微服务一样调度AI模型 - 统一控制平面、智能路由、成本优化、实时监控
  actions:
    - theme: brand
      text: 快速开始
...
features:
  ...
  - icon: 💰
    title: 预算管理
    details: 多层级预算控制(global/project/profile),请求前预算检查,HTTP 429超限响应,优雅降级
  - icon: 📊
    title: 精确成本追踪
    details: Token级别监控,三种估算级别(exact/mapped/heuristic),SQLite本地存储,支持多维度分析
  - icon: 🔄
    title: 实时定价更新
...
<div class="vp-doc">
  <div class="custom-block tip">
    ...
    <p>
      <a href="/guide/installation">安装配置</a> →
      <a href="/guide/getting-started">快速开始</a> →
      <a href="/guide/configuration">详细配置</a>
    </p>
  </div>
  ...
  <div class="custom-block info">
    ...
    <p>
      <a href="/features/routing">智能路由</a> |
      <a href="/features/budgets">预算管理</a> |
      <a href="/features/analytics">使用分析</a> |
      <a href="/features/adapters">Adapter集成</a>
    </p>
  </div>
  ...
  <div class="custom-block warning">
    ...
    <p>
      <a href="/reference/cli">CLI参考</a> |
      <a href="/reference/config-files">配置文件</a> |
      <a href="/advanced/troubleshooting">故障排查</a>
    </p>
  </div>
</div>
...
- 📖 [完整文档](https://royisme.github.io/BobaMixer/)
