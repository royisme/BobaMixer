...
func printUsage() {
	...
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  boba                    Launch interactive TUI dashboard")
	fmt.Println("  boba --help             Show this help message")
	fmt.Println("  boba --version          Show version information")
	fmt.Println()
	fmt.Println("Setup & Diagnostics:")
	fmt.Println("  boba init               Initialize ~/.boba configuration")
	fmt.Println("  boba doctor             Run system diagnostics")
	fmt.Println()
	fmt.Println("Non-Interactive Commands:")
	fmt.Println("  boba run <tool> [args]               Run a bound CLI tool")
	fmt.Println("  boba call --profile <p> --data @file Execute an API call")
	fmt.Println()
	fmt.Println("Quick Stats:")
	fmt.Println("  boba stats [--today|--7d|--30d]     Show usage statistics")
	fmt.Println()
	fmt.Println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	fmt.Println()
	fmt.Println("✨ All interactive features are available in the TUI dashboard!")
	fmt.Println()
	fmt.Println("Launch 'boba' to explore:")
	fmt.Println("  • Manage AI providers, CLI tools, and bindings")
	fmt.Println("  • Configure secrets and proxy settings")
	fmt.Println("  • View detailed statistics and trends")
	fmt.Println("  • Set budgets and apply optimizations")
	fmt.Println("  • Test routing rules and manage git hooks")
	fmt.Println("  • Generate reports and view session history")
	fmt.Println()
	fmt.Println("For more information: https://royisme.github.io/BobaMixer/")
}
